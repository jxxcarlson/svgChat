...
frontendMsg old =
    case old of
       Old.MessageFieldChanged str -> MsgUnchanged
       Old.MessageSubmitted -> MsgUnchanged
       Old.DragStart -> MsgUnchanged
       Old.DragMove _ -> MsgUnchanged
       Old.DragStop _ -> MsgUnchanged
       Old.Noop -> MsgUnchanged
